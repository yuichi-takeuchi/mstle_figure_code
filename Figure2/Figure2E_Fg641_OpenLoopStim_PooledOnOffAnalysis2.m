...
MetaInfo = struct(...
    ...
    'outputFileName', ['Figure' num2str(FigureNo) 'E_Fg' num2str(FgNo) '_' control 'LoopStim_PooledOnOff.mat'],...
    'mFileCopyName',  ['Figure' num2str(FigureNo) 'E_Fg' num2str(FgNo) '_' control 'LoopStim_PooledOnOffAnalysis2.m'],...
    'bitLabel', bitLabel,...
    'control', control,...
...
clear FigureNo FgNo control graphSuffix bitLabel
...
%         % supra
%         outputFileNameBase = ['Supra' MetaInfo.control 'Loop_Pooled' MetaInfo.graphSuffix '_'];
%         [ flag ] = figsf_BarScatPairedGray1( supraTbTh, VarNames, sBasicStatsSupra, CTitle, CVLabel, colorMat, outputGraph, outputFileNameBase);
%         clear flag outputFileNameBase; close all
%     end
% end
