...
MetaInfo = struct(...
    ...
    'outputFileName', ['Figure' Supplement num2str(FigureNo) Panel '_Fg' num2str(FgNo) '_' control 'LoopStim_3ANOVA.mat'],...
    'mFileCopyName',  ['Figure' Supplement num2str(FigureNo) Panel '_Fg' num2str(FgNo) '_' control 'LoopStim_3ANOVAAnalysis1.m'],...
    'bitLabel', bitLabel,...
    'control', control,...
    'FigureNo', FigureNo,...
    'FgNo', FgNo...
...
cd(MetaInfo.MatlabFolder)
copyfile([MetaInfo.MatlabFolder '\Yuichi\Epilepsy\template\eplpsys_3ANOVAAnalysis1.m'],...
    [MetaInfo.DataFolder '\' MetaInfo.mFileCopyName]);
% dependency
[ flag ] = dpf_getDependencyAndFiles( [MetaInfo.MatlabFolder '\Yuichi\Epilepsy\template\eplpsys_3ANOVAAnalysis1.m'],...
    MetaInfo.DataFolder);
clear flag
cd(MetaInfo.DataFolder)