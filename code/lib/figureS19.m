function [sBasicStats, sStatsTest, No] = figureS19(ratId, colorId)
...
for i = 1:3
    Off = Tb.(VarNames{i})(Tb.Laser == false);
    On  = Tb.(VarNames{i})(Tb.Laser == true);
