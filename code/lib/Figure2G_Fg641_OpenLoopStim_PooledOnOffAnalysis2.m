...
MetaInfo = struct(...
    ...
    'outputFileName', ['Figure' num2str(FigureNo) Panel '_Fg' num2str(FgNo) '_' control 'LoopStim_PooledOnOff.mat'],...
    'mFileCopyName',  ['Figure' num2str(FigureNo) Panel '_Fg' num2str(FgNo) '_' control 'LoopStim_PooledOnOffAnalysis2.m'],...
    'bitLabel', bitLabel,...
    'control', control,...
