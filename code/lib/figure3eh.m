function [sBasicStats, sStatsTest, sBasicStats_MI, sStatsTest_MI, percThrshlded, chi2] = figure3eh()
...
set(hfig,...
    ...
    'PaperPosition', [0 0 4 4],... % [h distance, v distance, width, height], origin: left lower corner
    'PaperSize', [4 4]... % width, height
    );
...
%% Separation of data by the threshold of MI (output is ~supraTbTh.csv file)
% parameters
threshold = gThreshold;
