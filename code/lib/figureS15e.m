function [sBasicStats, sStatsTest, sBasicStats_pa, sStatsTest_pa, No] = figureS15e()
...
for i = 1:length(VarNames)
    ...
    % building a plot
    [ hs ] = figf_BarMeanIndpndPlot2( supraTb.LTR, supraTb.(VarNames{i}), supraTb.Laser + 1, supraTbTh.Thresholded + 1, 0.4, hax );
