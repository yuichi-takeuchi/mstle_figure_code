function [sBasicStatsSupra, sStatsTestSupra, No] = figureS6j()
...
% cd(MetaInfo.MatlabFolder)
% copyfile([MetaInfo.MatlabFolder '\Yuichi\Epilepsy\template\eplpsys_PooledOnOffAnalysis2.m'],...
%     [MetaInfo.DataFolder '\' MetaInfo.mFileCopyName]);
% % dependency
% [ flag ] = dpf_getDependencyAndFiles( [MetaInfo.MatlabFolder '\Yuichi\Epilepsy\template\eplpsys_PooledOnOffAnalysis2.m'],...
%     MetaInfo.DataFolder);
% clear flag
% cd(MetaInfo.DataFolder)
