function [sBasicStats, sStatsTest, No] = figure3i()
...
set(hfig,...
    ...
    'PaperPosition', [0 0 10 4],... % [h distance, v distance, width, height], origin: left lower corner
    'PaperSize', [10 4]... % width, height
    );
...
hxlbl = xlabel('MS stimulation delay (ms)');
