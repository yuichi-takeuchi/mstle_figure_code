function [sBasicStats, sStatsTest, sBasicStats_pa, sStatsTest_pa, No] = figure3f()
...
for i = 1:length(VarNames)
    ...
    % building a plot
    [ hs ] = figf_BarMeanIndpndPlot2( supraTb.LTR, supraTb.(VarNames{i}), supraTb.MSEstm + 1, supraTbTh.Thresholded + 1, hax );
