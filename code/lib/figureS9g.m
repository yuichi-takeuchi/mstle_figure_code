function [sBasicStatsSupra, sStatsTestSupra, No] = figureS9g()
...
outputFileName = ['Figure' supplement num2str(figureNo) panel '_' control 'LoopStim_3ANOVA.mat'];
...
% supra
outputFileNameBase = ['Figure' supplement num2str(figureNo) panel '_Supra' control 'Loop_3ANOVA_']; 
